...
setup(
    ...
    install_requires=[
        ...
        "requests",
        "esef_auth==1.0.0.0",
        "django_simple_sso==0.9.3"
    ],
    dependency_links=[
        "https://github.com/egemsoft/esef-auth/tarball/master/#egg=esef_auth-1.0.0.0",
        "https://github.com/egemsoft/django-simple-sso/tarball/master#egg=django_simple_sso-0.9.3",
    ],
